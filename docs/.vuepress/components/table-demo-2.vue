<template>
  <div style="padding-top: 16px;">
    ...
    <div class="demo-box">
      <div class="top">
<lf-table :columns="columns" :data-source="dataSource" striped>
</lf-table>
      </div>
      <lf-collaspe>
        <p slot="one"><code>striped</code>属性可以创建带斑马纹的表格。它接受一个<code>Boolean</code>，默认为<code>false</code>，设置为<code>true</code>即为启用。</p>
