<template>
  <div style="padding-top: 16px;">
    ...
    <div class="demo-box">
      <div class="top">
<lf-table :columns="columns" :data-source="dataSource" bordered :height="400">
</lf-table>
      </div>
      <lf-collaspe>
        <p slot="one">只要在<code>lf-table</code>元素中定义了<code>height</code>属性，即可实现固定表头的表格，而不需要额外的代码。</p>
    ...
    data(){
        return {
                    ...
                    dataSource: [
                      ...
                      {id: 11, name: '美美', score: 99, age: 22},
                      {id: 12, name: '阿宇', score: 99, age: 26},
                    ],
        }
    }
}
